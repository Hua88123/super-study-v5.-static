...
function syncSeasonAutoRules(){
  ...
  return {peakWeeks,inPeak,outsidePeakWeeks,restore};
}
...
function calc(){
  ...
  let beforeSchool=base-low-longD+peak;

  let schoolEligibleBase=Math.max(0,base*(schoolRateWeeks/weeks)-low-longD);
