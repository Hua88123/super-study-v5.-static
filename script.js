...
function syncSeasonAutoRules(){
  ...
  setCheck("lowSeason", inPeak ? ((!!d.peakAllowLowSeasonDiscount || restore) && d.lowSeasonEnabled!==false) : d.lowSeasonEnabled!==false);
