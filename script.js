...
function calc(){
  ...
  // 学校淡季折扣：如果只适用于旺季外，就只按可享受折扣的周数对应的学费住宿基数计算。
  ...
  // 只要当前报价最终启用了专属/超能折扣，旺季附加费默认一起进入折扣基数。
