...
function calc(){
  ...
  let beforeSchool=base-low-longD-holidayD+peak;

  let schoolEligibleBase=Math.max(0,base*(schoolRateWeeks/weeks)-low-longD-holidayD);
